...
- Partida de **5:00**
- Seleção inicial: **Sander** ou **Lupe**
- Botão **PONTUAR** na Goal Zone + jingle *Aura Energy*
- Tela final com barras comparando os placares
- IA com estados explorar / perseguir / atacar / fugir
- Ordenação por Y (depth) + obstáculos
- Mapa pré-renderizado em buffer (tile 80px)
- Fundos pretos/xadrez removidos das sprites
